          ...
          <div className="w-full px-4">
            ...
            >
              ...
              >
                ...
                to <b>ELEVATE</b> the customer by delivering high quality of work and to <b>OPTIMIZE</b> the cost and resources.
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p className="mb-8 text-body-color lg:mb-11">
                We help you in integrating Generative AI capabilities to your existing applications or new solutions, preparing your tenant for Microsoft 365 Copilot and building custom Copilots or chat assistants using Azure OpenAI Services that can work on your organization's data securely.
              </p>
              {/* <a
                href="javascript:void(0)"
                className="text-base font-medium text-body-color hover:text-primary"
