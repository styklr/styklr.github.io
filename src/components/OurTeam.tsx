...
const OurTeam:React.FC = () => {  return(
  ...
  //           >
  //             <img
  //               src="/assets/images/team/team-male.jpg"
  //               alt="image"
  ...
  //             </p>
  //             <p className="mb-5 text-sm font-medium text-body-color">
  //               Generative AI | Microsoft 365 | Azure
  //             </p>                
  ...
  //           >
  //             <img
  //               src="/assets/images/team/team-female.jpg"
  //               alt="image"
  //               className="w-full rounded-full"
  //             />
  //             <span className="absolute top-0 left-0 z-[-1]">
  ...
  //           </div>
  //           <div className="text-center">
  //             <h4 className="mb-2 text-lg font-medium text-dark">Ramya Merla</h4>
  //             <p className="mb-5 text-sm font-medium text-body-color">
  //               Business Manager
  //             </p>
  //             <p className="mb-5 text-sm font-medium text-body-color">
  ...
  //             </p>
  //             <p className="mb-5 text-sm font-medium text-body-color">
  //               Microsoft 365 | AI | Power Platform
  //             </p>                
  //             {/* <div className="flex items-center justify-center">
  //               <a
  //                 href="javascript:void(0)"
