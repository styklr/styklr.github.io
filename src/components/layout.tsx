...
const Layout:React.FC<ILayoutProps> = (props) => {
    ...
    return (<>
        <Script src="/assets/js/wow.min.js" onLoad={() => {setWowJsLoaded(true);} }></Script>
        {wowJsLoaded && (
            <Script>{`
            new WOW().init();
          `}
    ...
    <div
      className="ud-header absolute top-0 left-0 z-40 flex w-full items-center bg-primary"
    >
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-60 max-w-full px-4">
            <a href="/" className="navbar-logo block w-full py-5">
              <img
                src="/assets/images/logo/logo_name_white.png"
                alt="logo"
                className="header-logo h-[40px]"
              />
            </a>
          </div>
      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">Services</h4>
              <ul>
                <li>
                  <Link
                    to="/#services"
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <ul className="flex flex-wrap items-center">
                <li>
                    <span className='mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary'>
                    If you would like to partner with us, please <Link to="/#contact">contact us</Link>
                    </span>
                </li>
                {/* <li>
                  <a
